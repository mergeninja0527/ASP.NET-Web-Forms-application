<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Announcement.aspx.vb" Inherits="SeymourWebsite.Announcement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <script type="text/javascript" lang="javascript">
           function ddlTopicChanged(s, e) { CallbackPanelAnnouncementRpt.PerformCallback('Search'); }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div id="main" style="height:1000px">
              <div class="header1">BULLETIN BOARD</div><br />
          <dx:ASPxComboBox ID="ddlTopic" runat="server"  CssClass="mainbodytext_0px"
                        style="z-index: 999; left: 372px; top:88px; position: absolute" 
                        Height="21px" Width="225px" Theme="Aqua" AutoPostBack="true" > 
               <%--<ClientSideEvents SelectedIndexChanged="ddlTopicChanged"></ClientSideEvents>--%>
                    </dx:ASPxComboBox>
            <dx:ASPxLabel ID="Label1" runat="server"  CssClass="mainbodytext_0px" Style="z-index: 102; left: 321px; position: absolute;
                 top: 91px" Text="Topic" Width="45px"></dx:ASPxLabel>
              <dx:ASPxCallbackPanel ID="CallbackPanel1"  ClientInstanceName="CallbackPanelAnnouncementRpt" runat="server" 
                 style="z-index: 100; left: 40px; top: 135px; position: absolute; height:800px; width: 800px;" >
                <PanelCollection>
                    <dx:PanelContent runat="server">

           <dx:ASPxDocumentViewer ID="ASPxDocumentViewer1" runat="server" 
        style="position:relative; top:0px; left: 40px;" Width="800px" Height="800px" Theme="Aqua">
